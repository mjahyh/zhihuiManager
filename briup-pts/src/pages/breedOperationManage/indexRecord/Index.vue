 ...
 * @LastEditors: Ronda
 * @LastEditTime: 2022-04-17 20:10:04
-->
<template>
  <div>
    <!-- {{ authsButton }} -->
    ...
    <div class="btns">
      <el-form :inline="true" size="small">
        ...
        <el-form-item v-if="roles.includes('admin')">
          <el-select v-model="param.irdUbreedId" clearable placeholder="检测人员">
    ...
    >
      <div slot="content">
        <el-form ref="record_form" :model="form" :rules="rules">
          <el-form-item label="动物编号" :label-width="formLabelWidth" prop="irdAnimalId">
            <el-input
          ...
          <el-form-item label="是否健康" :label-width="formLabelWidth" prop="irdHealthy">
            <el-radio-group v-model="form.irdHealthy">
              <el-radio label="健康" />
              <el-radio label="不健康" />
            </el-radio-group>
          </el-form-item>
          <el-form-item label="体重(KG)" :label-width="formLabelWidth" prop="irdWeight">
            <el-input
              v-model="form.irdWeight"
              autocomplete="off"
            />
          </el-form-item>
          <el-form-item label="体温(℃)" :label-width="formLabelWidth" prop="irdTemperature">
            <el-input
              v-model="form.irdTemperature"
              autocomplete="off"
            />
          </el-form-item>

          <el-form-item label="呼吸频率(次/分)" :label-width="formLabelWidth" prop="irdBreathing">
            <el-input
              v-model="form.irdBreathing"
              autocomplete="off"
            />
          </el-form-item>

          <el-form-item label="心率(次/分)" :label-width="formLabelWidth" prop="irdHeartRate">
            <el-input
              v-model="form.irdHeartRate"
              autocomplete="off"
            />
          </el-form-item>
          <el-form-item label="录入时间" :label-width="formLabelWidth" prop="irdTime">
            <el-date-picker
          ...
          <div v-if="roles.includes('admin')">
            ...
            <el-form-item label="指标记录人员" :label-width="formLabelWidth" prop="irdUbreedId">
              <el-select v-model="form.irdUbreedId" placeholder="请选择指标记录人员">
...
<script>
import { findByOption, saveOrUpdate, delById, deleteByIdAll, findAllRecordAccount } from '@/api/ptsOperational/indexRecord'
