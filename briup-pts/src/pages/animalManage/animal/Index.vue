 ...
 * @LastEditors: Ronda
 * @LastEditTime: 2022-04-17 19:56:15
-->
<template>
  <div>
    <!-- {{ authsButton }} -->
    ...
    >
      <div slot="content">
        <el-form ref="animal_form" :model="form" :rules="rules">
          <el-form-item label="初始体重(KG)" :label-width="formLabelWidth" prop="aWeight">
            <el-input
              v-model="form.aWeight"
              autocomplete="off"
            />
          </el-form-item>
          <el-form-item label="性别" :label-width="formLabelWidth" prop="aGender">
            <el-radio-group v-model="form.aGender">
              <el-radio label="雌性" />
              <el-radio label="雄性" />
            </el-radio-group>
          </el-form-item>
          <el-form-item label="健康状态" :label-width="formLabelWidth" prop="aHealthy">
            <el-radio-group v-model="form.aHealthy">
              <el-radio label="健康" />
              <el-radio label="生病" />
            </el-radio-group>
          </el-form-item>
          <el-form-item label="过程状态" :label-width="formLabelWidth" prop="aStatus">
          ...
          <el-form-item label="疫苗接种状态" :label-width="formLabelWidth" prop="aInoculate">
            <el-radio-group v-model="form.aInoculate">
              <el-radio label="未接种" />
              <el-radio label="已接种" />
            </el-radio-group>
          </el-form-item>
          <el-form-item label="所属批次" :label-width="formLabelWidth" prop="aBatchId">
            <el-select v-model="form.aBatchId" placeholder="请选择所属批次">
              <el-option v-for="item in batchData" :key="item.bSerialId" :label="item.bSerialId" :value="item.bSerialId" />
            </el-select>
          </el-form-item>
          <el-form-item label="所属栏圈" :label-width="formLabelWidth" prop="aHurdlesId">
            <el-select v-model="form.aHurdlesId" placeholder="请选择所属栏圈">
              <el-option v-for="item in hurdlesData" :key="item.hId" :label="item.hName+'-'+(item.managerFenceHouse?item.managerFenceHouse.fhName:'')" :value="item.hId" />
            </el-select>
          </el-form-item>
          <el-form-item label="购入时间" :label-width="formLabelWidth" prop="aTime">
            <el-date-picker
              v-model="form.aTime"
              type="datetime"
              placeholder="选择日期时间"
...
<script>
import { findByOption, saveOrUpdate, delById, deleteByIdAll, productQRCode } from '@/api/ptsBase/animal'
