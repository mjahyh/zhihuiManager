 ...
 * @LastEditors: Ronda
 * @LastEditTime: 2022-04-17 19:44:31
-->
      ...
      <el-col :span="tableSpan">
        <div class="btns">
          <el-form :inline="true" size="small">
            ...
            <el-button type="text" size="mini" @click="loadFenceHouse(1)">搜索</el-button>
          </el-form>
        </div>
        <el-table
          v-loading="loading"
      ...
      <el-col v-if="detailsVisible" :span="detailsSpan">
        <el-card v-loading="detailsLoading" class="box-card" size="mini">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0" type="text" @click="toCancelDetails">隐藏</el-button>
          </div>
          <div>
            栏舍描述：{{ details.fhDesc }}
          </div>
...
<script>
import { findByOption, saveOrUpdate, delById, deleteByIdAll, findById } from '@/api/ptsBase/fenceHouse'
// 按钮权限
  ...
  data() {
    return {
      ...
      rules: {
        ...
        fhTime: [
          { type: 'string', required: true, message: '请选择创建时间', trigger: 'change' }
        ]
      }
    }
  },
